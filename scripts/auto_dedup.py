...
# "일본증시동향"은 2026-09-18 jp_market_writer.py 신설 시점부터 동일
# 패턴(매일 "닛케이225, N일 N% 상승/하락…N로 마감" 템플릿 제목 반복)이
# 예상돼 미리 등록해둔다.
EXCLUDE_SUBCATEGORIES = {"국내유가", "국제유가", "글로벌마켓동향", "프론티어마켓동향", "복권당첨정보", "일본증시동향", "주간시세", "주간정리"}
