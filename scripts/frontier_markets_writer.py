...
2. 구조 — 아래 소제목을 본문에 그대로 포함하고 소제목 앞에는 빈 줄을 하나씩 두세요:
   ① 리드: ⚠️ 반드시 뉴욕증시(다우존스·나스닥·S&P500 중 그날 가장 중요한 움직임)로
      시작하세요. 다른 지역 지수가 그날 변동폭이 더 크더라도 리드는 뉴욕이어야
   ...
   ② [주요국 증시] 뉴욕 외 변동폭 상위 지수 2~3개(영국·일본·독일·프랑스 등)를,
      그 지수가 움직인 실제 이유(검색으로 찾은 뉴스 — 연준 금리 발표, 주요 기업
      실적, 경제 지표 등)와 함께 서술. 거래소명 포함. 뉴욕 지수 상세 수치가 ①에서
      다 안 다뤄졌으면 여기서 마저 다루세요.
...
3. ⚠️ 날짜: 반드시 리드(①) 문단에 "{today.day}일(현지시간)" 형식으로 날짜를 명시하세요
   (2026-08-26 실사고 — id=98019 등 최근 발행분에 날짜가 한 번도 안 들어감). "오늘",
   "현재", 절대연도(2026년 등)는 금지. 본문 전체에 날짜가 한 번도 안 나오면 안 됩니다.
