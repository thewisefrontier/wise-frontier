...
- 한국 투자자/독자 관점에서 왜 중요한지 마지막 1~2문장에 구체적으로 쓰세요. "영향을 미칠 것으로 보인다", "주목할 필요가 있다" 같은 막연한 문장은 금지 — 한국과 실제 연관이 있으면 어떤 품목·업종·기업이 어떻게 영향받는지 구체적으로, 연관이 약하면 억지로 갖다 붙이지 말고 이 사안이 해당 지역에서 왜 구조적으로 중요한지(공급망·안보 지형·유사 선례 비교 등)로 대체하세요. 사실 서술형으로만 쓰세요.
- 마크다운 문법, 헤더, 홍보 문구 금지.
...
- 마지막 1~2문장에 한국 연관성(관련 있으면 어떤 품목·업종·기업이 어떻게 영향받는지 구체적으로, 관련 약하면 이 사안이 해당 지역에서 구조적으로 왜 중요한지)을 담으세요. "영향을 미칠 것으로 보인다" 같은 막연한 문장은 금지.
- 모든 날짜는 사건이 일어난 현지시간 기준으로만 표기하세요. 한국 시간(KST)이나 UTC로 환산·계산하지 말고, 소스 기사에 나온 날짜를 하루도 앞뒤로 옮기지 말고 그대로 "N일(현지시간)" 형식으로 쓰세요. "2026년 7월 15일", "오늘", "현재" 같은 절대 날짜나 오늘 날짜는 쓰지 말고, 날짜를 알 수 없으면 쓰지 마세요.
- 마크다운 문법, 헤더, 홍보 문구 금지.
...
- 마지막 1~2문장에 한국 연관성(관련 있으면 어떤 품목·업종·기업이 어떻게 영향받는지 구체적으로, 관련 약하면 이 사안이 왜 구조적으로 중요한지)을 담으세요. "영향을 미칠 것으로 보인다" 같은 막연한 문장은 금지.
- 모든 날짜는 사건이 일어난 현지시간 기준으로만 표기하세요. 한국 시간(KST)이나 UTC로 환산·계산하지 말고, 소스 기사에 나온 날짜를 하루도 앞뒤로 옮기지 말고 그대로 "N일(현지시간)" 형식으로 쓰세요. "2026년 7월 15일", "오늘", "현재" 같은 절대 날짜나 오늘 날짜는 쓰지 말고, 날짜를 알 수 없으면 쓰지 마세요.
- 반드시 하나의 토픽만 다루세요.
- 마크다운 문법, 헤더, 홍보 문구 금지.
- 기사 문체로 작성하세요. "~를 보여줍니다", "~을 도모하고 있습니다", "~라는 평가다" 같은 논평/칼럼 문체는 금지입니다.
