...
아래 한국석유공사 오피넷 데이터를 바탕으로 "주간 국내 유가 동향" 기사를 작성하세요.

[이번 주 평균 유가] (출처: 한국석유공사 오피넷)
{price_lines}
{regional_line}
{intl_block}
...
5. 출처 표기: 리드에서만 "한국석유공사 오피넷"으로 기관명 전체를 밝히고, 본문 다른 곳에서
   다시 출처를 언급할 때는 "오피넷에 따르면"처럼 "오피넷"만 쓰세요. "오피넷(한국석유공사)"를
   본문에 두 번 이상 반복하지 마세요.
6. 분량: 500자 이상.
"""
